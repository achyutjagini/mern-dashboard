...
import { InputBase, useTheme, Box, Menu, MenuItem } from "@mui/material";
      ...
      <Toolbar sx={{ justifyContent: "space-between" }}>
        ...
        <FlexBetween gap="1.5rem">
          ...
          <FlexBetween>
            ...
            {/*a button is container for all here in sidebar a flexbetween is container*/}
            <Button onClick={handleClick} sx={{
              ...
              </Box> {/*closing the textAlign=left box*/}
